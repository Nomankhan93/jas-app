...
export function OfficeBearerCardPackage({
  ...
  useEffect(() => {
    const updateScale = () => {
      const stageWidth = visibleStageRef.current?.clientWidth || OFFICE_CARD_WIDTH
  ...
  return (
    <article className="rounded-[2rem] bg-white p-4 shadow-sm ring-1 ring-slate-200/70 sm:p-5 print:p-0 print:shadow-none print:ring-0">
      <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between print:hidden">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className="inline-flex w-full justify-center sm:w-auto items-center gap-2 rounded-2xl bg-[#f6d56f] px-4 py-2 text-sm font-black text-emerald-950 shadow-sm transition hover:bg-amber-300 disabled:cursor-not-allowed disabled:opacity-60"
          >
            <Download size={16} />
          ...
          <button
            ...
            disabled={Boolean(downloading)}
            className="inline-flex w-full justify-center sm:w-auto items-center gap-2 rounded-2xl bg-slate-950 px-4 py-2 text-sm font-black text-white shadow-sm transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-60"
          >
            <Download size={16} />
            Both Sides
          </button>
          <button
            ...
            className="inline-flex w-full justify-center sm:w-auto items-center gap-2 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-2 text-sm font-black text-emerald-900 shadow-sm transition hover:bg-emerald-100"
          >
            <Copy size={16} />
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex w-full justify-center sm:w-auto items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-black text-slate-800 no-underline shadow-sm transition hover:bg-slate-50"
          >
      ...
      <div ref={visibleStageRef} className="overflow-hidden rounded-[1.65rem] bg-slate-100 p-3 print:overflow-visible print:bg-white print:p-0">
        <ScaledOfficeCardShell scale={cardScale}>
          <div className="relative" style={{ width: OFFICE_CARD_WIDTH, height: OFFICE_CARD_HEIGHT }}>
