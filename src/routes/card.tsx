...
const cardPageText: Record<AppLanguage, CardPageText> = {
  en: {
    ...
    description: 'Preview, verify and download your official Jatt Alliance Sindh Welfare digital membership card.',
    refresh: 'Refresh',
  ...
  ur: {
    ...
    description: 'اپنا سرکاری جٹ الائنس سندھ ویلفیئر ڈیجیٹل ممبرشپ کارڈ دیکھیں، تصدیق کریں اور ڈاؤن لوڈ کریں۔',
    refresh: 'تازہ کریں',
    summaryMember: 'ممبر',
  ...
  sd: {
    ...
    description: 'پنهنجو سرڪاري جٽ الائنس سنڌ ويلفيئر ڊجيٽل ميمبرشپ ڪارڊ ڏسو، تصديق ڪريو ۽ ڊائون لوڊ ڪريو.',
    refresh: 'تازو ڪريو',
    summaryMember: 'ميمبر',
