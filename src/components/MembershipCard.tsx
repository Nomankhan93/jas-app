  ...
  return (
    <>
      <CardHeader
        ...
        title="JATT ALLIANCE SINDH WELFARE"
      ...
      <CardFooter>
        This card is digitally generated by Jatt Alliance Sindh Welfare. QR verification
...
function CardBack({
  ...
  return (
    <>
      <CardHeader
        logoUrl={logoUrl}
        label="Jatt Alliance Sindh Welfare"
          ...
          <section className="grid h-full min-h-0 grid-cols-2 grid-rows-[1fr_1.05fr_1.3fr] gap-4">
            ...
            <BackPanel title="Terms and Conditions">
              <ul className="list-disc space-y-1 pl-4">
                <li>This card remains property of Jatt Alliance Sindh Welfare.</li>
      ...
      <div className="relative flex items-start justify-between gap-6">
        <div className="flex min-w-0 items-start gap-5">
          ...
          <div className="min-w-0 max-w-[830px]">
            ...
            <h2 className="mt-3 whitespace-nowrap text-[44px] font-black uppercase leading-[0.94] tracking-[-0.055em] text-white">
              {title}
            </h2>
