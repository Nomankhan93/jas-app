...
function CardFront({
  ...
  const casteBranch = member.caste_branch || 'Not provided'
        ...
        <div className="relative grid h-full grid-cols-[270px_1fr_230px] gap-8 p-8">
          ...
          <section className="flex flex-col justify-between">
            ...
            <div className="grid grid-cols-2 gap-x-12 gap-y-4">
              ...
              <Info label="Caste Branch" value={casteBranch} />
              <Info
                label="Approved Date"
          ...
          <section className="grid h-full min-h-0 grid-cols-2 grid-rows-[1fr_1.05fr_1.3fr] gap-4">
            ...
            <BackPanel title="Member Information" contentClassName="flex items-center">
              <div className="grid w-full grid-cols-3 gap-x-4 gap-y-3">
                ...
                <MiniInfo label="Caste Branch" value={member.caste_branch || 'Not provided'} />
            ...
            >
              <div className="flex h-[128px] items-center justify-center overflow-hidden rounded-2xl bg-white/80 px-4 ring-1 ring-slate-200">
                <img
                  src={SIGNATURE_PATH}
                  alt="Authorized signature"
                  className="h-[138px] w-[700px] max-w-[98%] object-contain object-center brightness-75 contrast-150 saturate-0"
